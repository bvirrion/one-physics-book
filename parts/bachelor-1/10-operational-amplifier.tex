...
A sensor of Th\'evenin resistance \qty{10}{k\ohm} feeding a \qty{1}{k\ohm}
...
\begin{enumerate}
  ...
  \item Each midpoint is the output of a divider of two \qty{1}{k\ohm}
        \omterm{def:b1:dc-circuits:resistor}{resistors}: what is the Th\'evenin resistance seen between the
        two midpoints?
