...
courtes \omterm{def:g10:light-spectra:wavelength}{longueurs d'onde}.
...
longues \omterm{def:g10:light-spectra:wavelength}{longueurs d'onde}. Par la loi de Wien le premier est le
plus chaud.
\end{solution}
...
\omterm{def:g10:light-spectra:wavelength}{longueur d'onde}, les deux \omterm{def:g10:light-spectra:white}{spectres} échangeant brillant et sombre.
\end{solution}
...
pic $\lambda_{\max}$ se déplace vers les courtes \omterm{def:g10:light-spectra:wavelength}{longueurs d'onde},
