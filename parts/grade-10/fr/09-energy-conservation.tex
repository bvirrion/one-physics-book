...
\omterm{def:g10:energy-conservation:efficiency}{rendements}~: une centrale (\omterm{def:g10:energy-conservation:power}{puissance} $0{,}38$) alimentant
...
$100$. La vie quotidienne couvre dix \omterm{def:g10:orders-of-magnitude:oom}{ordres de grandeur}.}
\end{omfigure}
...
\begin{enumerate}[resume]
  ...
  \item La région moyenne l'équivalent de \qty{4.0}{h} de plein soleil
        par jour~: \omterm{def:g10:energy-conservation:efficiency}{rendement} journalier de \qty{1}{m^2}~?
...
\begin{enumerate}[resume]
  ...
  \item Un éclair de \qty{5}{GJ} égale combien de jours-maison~? Compte
        ...
        quand même pas alimenter la maison~?
  \item Les \omterm{def:g10:energy-conservation:energy}{joules} ne se perdent jamais, pourtant les
