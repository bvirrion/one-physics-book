...
la \omterm{def:g10:refraction:angles}{normale}, de l'autre côté de la \omterm{def:g10:refraction:angles}{normale}, et les \omterm{def:g10:refraction:angles}{angles
d'incidence} et de \omterm{def:g10:refraction:refraction}{réfraction} satisfont
\[
n_1 \sin i_1 = n_2 \sin i_2 ,
\]
où $n_1$ et $n_2$ sont les \omterm{def:g10:refraction:index}{indices de réfraction} des deux milieux. Le
...
La formule suit de la loi de Snell--Descartes appliquée aux
...
les \omterm{def:g10:light-spectra:white}{spectres} du~\cref{ch:g10:light-spectra} l'ont montré. La
...
(courte \omterm{def:g10:light-spectra:wavelength}{longueur d'onde}) que pour la lumière rouge
(longue \omterm{def:g10:light-spectra:wavelength}{longueur d'onde}) --- donc le bleu se courbe davantage.
\end{definition}
...
$n_{\text{blue}} = 1.53$. La loi de Snell--Descartes, une fois par
couleur~:
\[
...
sens de rotation, élargit l'éventail, et à quelques \omterm{def:g10:orders-of-magnitude:unit}{mètres} les couleurs
...
La loi de Snell--Descartes contient un piège. En allant de
...
\begin{proof}
Poser $i_2 = 90^\circ$ dans la loi de Snell--Descartes~:
$n_1 \sin i_c = n_2 \sin 90^\circ = n_2$. Pour $i_1 > i_c$, la
loi de Snell--Descartes exigerait
...
\begin{enumerate}
  ...
  \item Pourquoi tracer $\sin i_2$ en fonction de $\sin i_1$ est-il un
        meilleur test de la loi de Snell--Descartes que tracer
...
loi de Snell--Descartes, pourquoi il n'y a pas d'\omterm{def:g10:refraction:critical}{angle
...
\begin{enumerate}[resume]
  \item Une piscine a \qty{3.0}{m} de profondeur. En utilisant la
        formule de \omterm{prop:g10:refraction:depth}{profondeur apparente}
...
\begin{enumerate}[resume]
  ...
  \item La chute. Une paire de fibres moderne porte environ $10^{13}$
        ...
        phrase, ce que la loi de Snell--Descartes fait pour
        l'internet.
\end{enumerate}
\end{problem}
