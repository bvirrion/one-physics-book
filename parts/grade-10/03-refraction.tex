...
crosses over (\emph{\omterm{def:g10:refraction:refraction}{refraction}}). Both obey exact geometric laws, stated
with one convention: angles are measured from the \emph{\omterm{def:g10:refraction:angles}{normal}}, never
from the surface.
...
reflection and of \omterm{def:g10:refraction:refraction}{refraction} are measured from the normal in the same
way.
\end{definition}
...
\omterm{def:g10:refraction:angles}{normal}, on the other side of the \omterm{def:g10:refraction:angles}{normal}, and the angle of reflection
equals the \omterm{def:g10:refraction:angles}{angle of incidence}:
\[
i_1' = i_1 .
\]
\end{proposition}
...
mirror's surface, as beams are often described. The \omterm{def:g10:refraction:angles}{angle of incidence} is
$90^\circ - 35^\circ = 55^\circ$, so the reflected ray also leaves at
$55^\circ$ from the \omterm{def:g10:refraction:angles}{normal}, and the beam turns by
$180^\circ - 2 \times 55^\circ = 70^\circ$. Forgetting the
\omterm{def:g10:refraction:angles}{normal} convention is the most common error of this chapter; it costs
$90^\circ$ every time.
\end{example}
...
angle from the \omterm{def:g10:refraction:angles}{normal} is the angle of refraction $i_2$.
\end{definition}

\omterm{def:g10:refraction:refraction}{Refraction} happens because light has different speeds in different
...
has no \omterm{def:g10:orders-of-magnitude:unit}{unit}. Some useful values:
\begin{center}
...
\index{Snell's law}
The \omterm{def:g10:refraction:refraction}{refracted ray} lies in the plane of the incident ray and the \omterm{def:g10:refraction:angles}{normal},
on the other side of the \omterm{def:g10:refraction:angles}{normal}, and the angles of incidence and
\omterm{def:g10:refraction:refraction}{refraction} satisfy
\[
n_1 \sin i_1 = n_2 \sin i_2 ,
\]
where $n_1$ and $n_2$ are the refractive indices of the two media. The
path is reversible: light traveling backwards along the \omterm{def:g10:refraction:refraction}{refracted ray}
exits along the incident ray.
\end{theorem}
\admitted

\begin{remark}\label{rem:g10:refraction:honest}
The laws of reflection and \omterm{def:g10:refraction:refraction}{refraction} are stated here as experimental
...
angles are measured from the \omterm{def:g10:refraction:angles}{normal} (dashed); entering the denser
medium ($n_2 > n_1$), the ray bends \emph{toward} the \omterm{def:g10:refraction:angles}{normal}.}
\end{omfigure}
...
i_2 = 22.1^\circ .
\]
The ray bends toward the \omterm{def:g10:refraction:angles}{normal}, as it always does when entering a
slower medium ($n_2 > n_1$). Leaving the water, the same computation runs
backwards and the ray bends \emph{away} from the \omterm{def:g10:refraction:angles}{normal}.
\end{example}

\begin{method}[Solving a refraction problem]\label{met:g10:refraction:method}
\begin{enumerate}
  \item Draw the surface, the \omterm{def:g10:refraction:angles}{normal}, and the ray; identify $n_1$
        (medium of the incident ray) and $n_2$.
  \item Check that the given angles are measured from the \omterm{def:g10:refraction:angles}{normal};
  ...
  \item Sanity check: the ray bends toward the \omterm{def:g10:refraction:angles}{normal} if $n_2 > n_1$,
...
line \emph{is} \omterm{thm:g10:refraction:snell}{Snell's law}.
...
appears to be at the \emph{\omterm{prop:g10:refraction:depth}{apparent depth}}
\[
d' = \frac{d}{n} ,
\]
...
The formula follows from \omterm{thm:g10:refraction:snell}{Snell's law} applied to the almost-vertical rays
...
away from the \omterm{def:g10:refraction:angles}{normal}, so the eye traces them back to a point higher
than the object.
\end{remark}
...
\cref{ch:g10:light-spectra} showed. \omterm{def:g10:refraction:refraction}{Refraction} explains \emph{why}: the
\omterm{def:g10:refraction:index}{refractive index} of a medium is not quite the same for every color.

\begin{definition}[Dispersion]\label{def:g10:refraction:dispersion}
A medium is \emph{dispersive}\index{dispersion} when its \omterm{def:g10:refraction:index}{refractive
index} depends on the \omterm{def:g10:light-spectra:wavelength}{wavelength} of the light. In glass and water, $n$ is
slightly larger for blue light (short \omterm{def:g10:light-spectra:wavelength}{wavelength}) than for red light
(long \omterm{def:g10:light-spectra:wavelength}{wavelength}) --- so blue bends more.
\end{definition}

\begin{example}[Two colors, one surface]\label{ex:g10:refraction:twocolors}
A beam of \omterm{def:g10:light-spectra:white}{white light} hits crown glass at $i_1 = 60^\circ$. For this
glass $n_{\text{red}} = 1.51$ and $n_{\text{blue}} = 1.53$. \omterm{thm:g10:refraction:snell}{Snell's law},
once per color:
\[
...
\]
A single surface splits \omterm{def:g10:light-spectra:white}{white light} by half a degree --- invisible on a
...
\omterm{thm:g10:refraction:snell}{Snell's law} contains a trap. Going from water toward air, the \omterm{def:g10:refraction:refraction}{refracted
ray} bends away from the \omterm{def:g10:refraction:angles}{normal}: $\sin i_2 = 1.33 \sin i_1 > \sin i_1$.
Increase $i_1$, and the formula soon demands $\sin i_2 > 1$, which no
angle can deliver. \omterm{def:g10:refraction:refraction}{Refraction} then simply stops happening.
...
$i_c$ is the \omterm{def:g10:refraction:angles}{angle of incidence} for which the \omterm{def:g10:refraction:refraction}{refracted ray} grazes the
surface ($i_2 = 90^\circ$). For $i_1 > i_c$ no \omterm{def:g10:refraction:refraction}{refracted ray} exists: the
...
\begin{proof}
Set $i_2 = 90^\circ$ in \omterm{thm:g10:refraction:snell}{Snell's law}: $n_1 \sin i_c = n_2 \sin 90^\circ
= n_2$. For $i_1 > i_c$, \omterm{thm:g10:refraction:snell}{Snell's law} would require
...
{\small From water toward air, at increasing incidence: \omterm{def:g10:refraction:refraction}{refraction} away
from the \omterm{def:g10:refraction:angles}{normal}, then a \omterm{def:g10:refraction:refraction}{refracted ray} grazing the surface at the
\omterm{def:g10:refraction:critical}{critical angle}, then \omterm{def:g10:refraction:critical}{total internal reflection} --- the surface has
...
in diamond, any ray more than $24.4^\circ$ off a facet's \omterm{def:g10:refraction:angles}{normal} is
...
\omterm{def:g10:refraction:critical}{Total internal reflection} turns a glass thread into a pipe for light:
a ray entering nearly parallel to the axis strikes the wall far beyond
the \omterm{def:g10:refraction:critical}{critical angle}, reflects without loss, and does so millions of times
...
Light injected at one end travels along the core by repeated \omterm{def:g10:refraction:critical}{total
...
{\small Light guided along the \omterm{def:g10:refraction:fiber}{core} of a fiber by \omterm{def:g10:refraction:critical}{total internal
reflection} (bounce angles greatly exaggerated: real rays graze the wall
at more than $80^\circ$ from the \omterm{def:g10:refraction:angles}{normal}).}
\end{omfigure}
...
\omterm{def:g10:refraction:fiber}{core} the light travels at $v = c/1.48 = \qty{2.03e8}{m/s}$: a pulse
...
\omterm{def:g10:light-spectra:wavelength}{wavelengths} at once; a whole cable reaches $10^{14}$ bits per second,
...
surface}. Give the \omterm{def:g10:refraction:angles}{angle of incidence}, the angle of reflection, and the
...
\begin{enumerate}
  ...
  \item In a certain solid, light travels at \qty{1.97e8}{m/s}. Compute
        its \omterm{def:g10:refraction:index}{refractive index} and identify the material.
\end{enumerate}
\end{exercise}

\begin{exercise}[$\star$]\label{exo:g10:refraction:3}
A ray in air strikes a glass block ($n = 1.50$) at $i_1 = 40^\circ$.
Compute the angle of \omterm{def:g10:refraction:refraction}{refraction}. At what angle would a ray traveling
...
Compute the angle of the \omterm{def:g10:refraction:refraction}{refracted ray}, and state whether the ray bends
toward or away from the \omterm{def:g10:refraction:angles}{normal} --- with the one-word reason.
\end{exercise}

\begin{exercise}[$\star$]\label{exo:g10:refraction:5}
To identify a clear liquid, a ray is sent onto its surface at
$i_1 = 45^\circ$; the \omterm{def:g10:refraction:refraction}{refracted ray} is measured at $i_2 = 32^\circ$.
Compute the \omterm{def:g10:refraction:index}{refractive index} and identify the liquid from the table of
...
\begin{enumerate}
  \item Compute $\dfrac{\sin i_1}{\sin i_2}$ for each pair. What do you
        observe?
  \item Deduce the \omterm{def:g10:refraction:index}{refractive index} of the plastic and identify it.
  \item Why is plotting $\sin i_2$ against $\sin i_1$ a better test of
        \omterm{thm:g10:refraction:snell}{Snell's law} than plotting $i_2$ against $i_1$?
\end{enumerate}
\end{exercise}

\begin{exercise}[$\star\star$]\label{exo:g10:refraction:7}
Compute the \omterm{def:g10:refraction:critical}{critical angle} toward air for water, glass ($n = 1.50$) and
diamond. Then explain, with \omterm{thm:g10:refraction:snell}{Snell's law}, why there is no \omterm{def:g10:refraction:critical}{critical angle}
...
\begin{enumerate}
  \item Compute the angle of \omterm{def:g10:refraction:refraction}{refraction} at the first face.
  \item The \omterm{def:g10:refraction:refraction}{refracted ray} hits the second face from inside, at the same
...
\omterm{def:g10:light-spectra:white}{White light} strikes a block of flint glass at $55^\circ$. For this
glass, $n_{\text{red}} = 1.61$ and $n_{\text{blue}} = 1.66$. Compute the
\omterm{def:g10:refraction:refraction}{refraction} angles of the red and blue rays and the angle between them.
Which color ends up closer to the \omterm{def:g10:refraction:angles}{normal}?
\end{exercise}

\begin{exercise}[$\star\star$]\label{exo:g10:refraction:11}
An \omterm{def:g10:refraction:fiber}{optical fiber} has a \omterm{def:g10:refraction:fiber}{core} of index $1.48$ and a \omterm{def:g10:refraction:fiber}{cladding} of index
$1.46$.
\begin{enumerate}
  \item Compute the \omterm{def:g10:refraction:critical}{critical angle} on the core--cladding boundary.
  \item A guided ray bounces along at exactly the \omterm{def:g10:refraction:critical}{critical angle}. Show
...
\omterm{def:g10:refraction:refraction}{refraction}, the diver sees the \emph{entire} sky compressed into a
bright disc directly overhead --- Snell's window.
\begin{enumerate}
  \item Explain why light from the horizon reaches the diver's eye at
        the \omterm{def:g10:refraction:critical}{critical angle} of water, $48.8^\circ$ from the vertical.
...
\omterm{def:g10:light-spectra:white}{white light} enters perpendicular to one of the sides adjacent to the right angle,
...
\begin{enumerate}
  ...
  \item The prism is replaced by a $45^\circ$--$45^\circ$--$90^\circ$
        prism, so the internal \omterm{def:g10:refraction:angles}{angle of incidence} becomes $45^\circ$.
...
\begin{enumerate}
  ...
  \item The periscope floods and the long face is now in contact with
        water. Compute the new \omterm{def:g10:refraction:critical}{critical angle} of the glass--water
...
A transatlantic cable runs \qty{6200}{km} of fiber (\omterm{def:g10:refraction:fiber}{core} index $1.47$)
between London and New York.
\begin{enumerate}
  \item Compute the speed of light in the \omterm{def:g10:refraction:fiber}{core} and the one-way travel
        time of a pulse.
...
\begin{enumerate}
  ...
  \item A ray in air strikes a pond at $i_1 = 40^\circ$. Compute the
        angle of \omterm{def:g10:refraction:refraction}{refraction}.
  \item A ray in the water hits the surface from below at $28.9^\circ$.
        ...
        this illustrates.
  \item Compute the \omterm{def:g10:refraction:critical}{critical angle} of the water--air boundary, and
...
\begin{enumerate}[resume]
  \item Compute the \omterm{def:g10:refraction:critical}{critical angle} of diamond ($n = 2.42$) toward air,
        and compare it with that of glass ($n = 1.52$),
        which is $41.1^\circ$.
  \item A ray inside the stone hits a facet at $30^\circ$ from its
        \omterm{def:g10:refraction:angles}{normal}. What happens in the diamond? In the glass imitation?
        Explain in one sentence why the cut of a diamond, combined with
        its tiny \omterm{def:g10:refraction:critical}{critical angle}, produces the sparkle.
  \item Diamond is also strongly \omterm{def:g10:refraction:dispersion}{dispersive}: $n_{\text{red}} = 2.41$,
        $n_{\text{blue}} = 2.45$. \omterm{def:g10:light-spectra:white}{White light} enters a facet at
        $45^\circ$; compute the \omterm{def:g10:refraction:refraction}{refraction} angle for each color and the
        angular split.
  \item Later, red and blue rays both reach an exit facet from inside
        ...
        to \omterm{def:g10:refraction:dispersion}{dispersion} near the \omterm{def:g10:refraction:critical}{critical angle}?
  \item A drop of water ($n = 1.33$) coats a facet. Compute the new
        \omterm{def:g10:refraction:critical}{critical angle} of the diamond--water boundary, decide the fate
...
\begin{enumerate}[resume]
  \item A fiber has a \omterm{def:g10:refraction:fiber}{core} of index $1.48$ and a \omterm{def:g10:refraction:fiber}{cladding} of index
        $1.46$. Compute the \omterm{def:g10:refraction:critical}{critical angle} on the core--cladding
        boundary.
  \item A bare glass thread in air would have a \omterm{def:g10:refraction:critical}{critical angle} of
        $42.5^\circ$ --- seemingly far better. Give two reasons the
        \omterm{def:g10:refraction:fiber}{cladding} is used anyway. (Think about dust, scratches, and what
        touching the surface would do to \omterm{def:g10:refraction:critical}{total internal reflection}.)
  \item Compute the speed of light in the \omterm{def:g10:refraction:fiber}{core}, then the one-way travel
        time of a pulse along \qty{6000}{km} of fiber.
  \item A ray bouncing at exactly the \omterm{def:g10:refraction:critical}{critical angle} travels
  ...
  \item The punchline. A modern fiber pair carries about $10^{13}$ bits
        ...
        then state, in one sentence, what \omterm{thm:g10:refraction:snell}{Snell's law} does for the
        internet.
\end{enumerate}
\end{problem}
