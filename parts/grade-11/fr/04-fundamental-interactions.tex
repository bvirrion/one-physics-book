...
{\small L'échelle de structure sur un axe en \omterm{def:g10:energy-conservation:power}{puissances} de dix~:
...
mince~; pourquoi l'\omterm{def:g10:orders-of-magnitude:scinot}{exposant}
...
colle forte est à courte \omterm{def:g11:fundamental-interactions:strong}{portée}~: un
\omterm{def:g11:fundamental-interactions:ladder}{nucléon} ne lie que ses quelques voisins
dans \qty{e-15}{m}. La répulsion électrique est à longue \omterm{def:g11:fundamental-interactions:strong}{portée}~: chaque
...
\omterm{def:g10:inertia:force}{forces} électrique et gravitationnelle entre
...
\omterm{def:g10:universal-gravitation:weight}{poids}, la tension
...
liaison la batte de quinze \omterm{def:g10:orders-of-magnitude:oom}{ordres de grandeur}.
\end{exercise}
