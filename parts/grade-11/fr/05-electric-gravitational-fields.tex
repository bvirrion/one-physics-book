...
Si la tension entre les plaques
...
\unit{V/m}. Des écarts minces font des
...
faisceau dévie visiblement (la \omterm{def:g10:relative-motion:trajectory}{trajectoire} courbe est l'affaire du
...
jamais --- il ne fait que s'amincir en $1/d^2$~; c'est le
...
tension jusqu'à ce qu'une gouttelette
...
sa chute lente \omterm{def:g11:electric-gravitational-fields:field}{champ} éteint~; nous la prenons comme donnée)~; les
