...
entire planet. That easy victory is why \omterm{def:g11:fundamental-interactions:ladder}{atoms} hold together and why
...
planetary systems (\qty{e11}{m}), galaxies (\qty{e21}{m}) and the
observable universe (\qty{e26}{m}).
\end{definition}
...
\omterm{def:g10:inertia:force}{force} not reducible to other \omterm{def:g10:inertia:force}{forces}; there are exactly four:
\emph{gravitation}\index{gravitation}, the \emph{electromagnetic interaction}\index{electromagnetic interaction},
the \omterm{def:g11:fundamental-interactions:strong}{strong interaction} and the \omterm{def:g11:fundamental-interactions:weak}{weak interaction}.
\end{definition}

\begin{remark}\label{rem:g11:fundamental-interactions:empty}
The floors are separated by voids: an \omterm{def:g11:fundamental-interactions:ladder}{atom} is $10^{5}$ times wider than
its \omterm{def:g11:fundamental-interactions:ladder}{nucleus} --- scale the \omterm{def:g11:fundamental-interactions:ladder}{nucleus} up to a \qty{1}{cm} marble and the
...
{\small The ladder of structure on a powers-of-ten axis: forty-four
decades separate the \omterm{def:g11:fundamental-interactions:ladder}{quark} from the observable universe. Sizes in
\omterm{def:g10:orders-of-magnitude:unit}{metres}.}
\end{omfigure}
...
on which the \omterm{def:g11:fundamental-interactions:four}{electromagnetic interaction} acts, as mass is the property
\omterm{def:g11:fundamental-interactions:four}{gravitation} acts on. It is measured in \emph{coulombs}\index{coulomb}
...
other \omterm{def:g10:inertia:force}{forces} along the line joining them, of equal magnitudes and
...
Coulomb established the law in 1785 by measuring the twist of a \omterm{def:g11:lenses-and-eye:lens}{thin}
torsion fibre; why the \omterm{def:g10:orders-of-magnitude:scinot}{exponent} is exactly $2$ is answered in the university volumes.
\end{remark}
...
two \omterm{def:g10:inertia:force}{forces} always have equal magnitudes and opposite directions.}
\end{omfigure}

\begin{remark}[A formal twin of gravitation]\label{rem:g11:fundamental-interactions:twin}
Coulomb's law is, symbol for symbol, the law of universal \omterm{def:g11:fundamental-interactions:four}{gravitation}
...
\approx \qty{2.3e2}{N}
\]
--- the \omterm{def:g10:universal-gravitation:weight}{weight} of a $23$-kg suitcase, carried by a particle of
$10^{-27}$ \omterm{def:g10:orders-of-magnitude:unit}{kilograms}. Gravitational attraction:
$F_G = \num{6.67e-11} \times (\num{1.67e-27})^{2} /
...
The example leaves a scandal: a helium \omterm{def:g11:fundamental-interactions:ladder}{nucleus} holds two protons that
repel with tens of \omterm{def:g10:inertia:force}{newtons} --- and yet helium exists.

\begin{definition}[The strong interaction]\label{def:g11:fundamental-interactions:strong}
The \emph{strong interaction}\index{strong interaction} binds \omterm{def:g11:fundamental-interactions:ladder}{quarks}
into \omterm{def:g11:fundamental-interactions:ladder}{nucleons} and \omterm{def:g11:fundamental-interactions:ladder}{nucleons} into nuclei. At \qty{e-15}{m} it is
attractive and far stronger than the electric repulsion (thousands of
\omterm{def:g10:inertia:force}{newtons} between \omterm{def:g11:fundamental-interactions:ladder}{nucleons}); beyond a few $10^{-15}$ \omterm{def:g10:orders-of-magnitude:unit}{metres} it vanishes:
...
{\small The tug-of-war inside a \omterm{def:g11:fundamental-interactions:ladder}{nucleus}: at $10^{-15}$~m the strong
attraction (thousands of \omterm{def:g10:inertia:force}{newtons}) beats the electric repulsion.}
\end{omfigure}

\begin{remark}[Why nuclei exist --- and why heavy ones give way]\label{rem:g11:fundamental-interactions:nuclei}
The two \omterm{def:g10:inertia:force}{forces} in the \omterm{def:g11:fundamental-interactions:ladder}{nucleus} scale differently. The strong glue is
short-ranged: a \omterm{def:g11:fundamental-interactions:ladder}{nucleon} binds only its few neighbours within
...
The \emph{weak interaction}\index{weak interaction}, of \omterm{def:g11:fundamental-interactions:strong}{range} shorter
...
To find which interaction rules a structure of size $d$, check \omterm{def:g11:fundamental-interactions:strong}{range}
and cancellation:
\begin{enumerate}
  \item $d \leq \qty{e-14}{m}$: the \emph{\omterm{def:g11:fundamental-interactions:strong}{strong interaction}} rules ---
        it beats the electric repulsion, and gravity is $10^{36}$ out.
  \item \omterm{def:g11:fundamental-interactions:ladder}{atoms} to mountains ($\qty{e-10}{m}$ to $\qty{e4}{m}$): the
        strong \omterm{def:g10:inertia:force}{force} is out of \omterm{def:g11:fundamental-interactions:strong}{range}; the \emph{\omterm{def:g11:fundamental-interactions:four}{electromagnetic
        interaction}} rules --- bonds, cohesion, \omterm{def:g10:inertia:inventory}{friction}, contact.
  \item planets and beyond ($d \geq \qty{e6}{m}$): matter is neutral to
        fantastic precision, so electricity cancels itself; mass has
        one sign and always adds --- \emph{\omterm{def:g11:fundamental-interactions:four}{gravitation}} rules the sky.
\end{enumerate}
The \omterm{def:g11:fundamental-interactions:weak}{weak interaction} holds no floor: it binds nothing, but arbitrates
...
{\small Who rules where: strong for nuclei, electromagnetic from \omterm{def:g11:fundamental-interactions:ladder}{atoms}
to mountains, \omterm{def:g11:fundamental-interactions:four}{gravitation} for planets and beyond. Sizes in \omterm{def:g10:orders-of-magnitude:unit}{metres}.}
\end{omfigure}

\section{Exercises}

\begin{exercise}[$\star$]\label{exo:g11:fundamental-interactions:1}
Give the \omterm{def:g10:orders-of-magnitude:oom}{order of magnitude} of each size and its floor of the ladder:
proton \qty{1.7e-15}{m}; water \omterm{def:g11:fundamental-interactions:ladder}{molecule} \qty{2.8e-10}{m}; grain of sand
...
\qty{30}{cm} apart. Compute the \omterm{def:g10:inertia:force}{force}; attractive or repulsive?
Compare the \omterm{def:g10:inertia:force}{forces} on $q_1$ and on $q_2$.
\end{exercise}

\begin{exercise}[$\star$]\label{exo:g11:fundamental-interactions:4}
Two charges attract with a \omterm{def:g10:inertia:force}{force} $F_0$. What does it become if: the
...
\omterm{def:g11:fundamental-interactions:ladder}{nucleus}; (d) the $\beta$ decay of carbon-14; (e) the balloon of
...
The two protons of a helium \omterm{def:g11:fundamental-interactions:ladder}{nucleus} sit $d = \qty{2.0e-15}{m}$ apart
($m_p = \qty{1.67e-27}{kg}$). Compute their electric repulsion, their
gravitational attraction, and the ratio. What keeps the \omterm{def:g11:fundamental-interactions:ladder}{nucleus} whole?
\end{exercise}

\begin{exercise}[$\star\star$]\label{exo:g11:fundamental-interactions:7}
In a hydrogen \omterm{def:g11:fundamental-interactions:ladder}{atom}, the electron ($m_e = \qty{9.11e-31}{kg}$) sits
$d = \qty{5.3e-11}{m}$ from the proton ($m_p = \qty{1.67e-27}{kg}$).
Compute the electric and \omterm{def:g10:universal-gravitation:force}{gravitational forces} between them and their
ratio. What holds \omterm{def:g11:fundamental-interactions:ladder}{atoms} together?
\end{exercise}
...
the \omterm{def:g10:inertia:force}{force} between them --- attractive or repulsive?
\end{exercise}
...
how far apart are they? Where does the \omterm{def:g10:inertia:force}{force} drop to \qty{0.10}{N}?
\end{exercise}

\begin{exercise}[$\star\star$]\label{exo:g11:fundamental-interactions:10}
Two protons in neighbouring \omterm{def:g11:fundamental-interactions:ladder}{molecules} sit $d = \qty{1.0e-10}{m}$ apart.
Compute their electric repulsion. What does the \omterm{def:g11:fundamental-interactions:strong}{strong interaction}
contribute at this distance? Which interaction binds \omterm{def:g11:fundamental-interactions:ladder}{molecules}?
\end{exercise}
...
Compute each coin's charge, then the \omterm{def:g10:inertia:force}{force}. The \omterm{def:g10:universal-gravitation:weight}{weight} of what mass
...
A uranium \omterm{def:g11:fundamental-interactions:ladder}{nucleus} has diameter \qty{1.4e-14}{m} and $92$ protons.
Compute the repulsion between two protons at opposite ends. Can the
\omterm{def:g11:fundamental-interactions:strong}{strong interaction} bind this pair --- why not? How many repelling
...
apart. Each ball is in equilibrium under its \omterm{def:g10:universal-gravitation:weight}{weight}, the thread's
\omterm{def:g10:inertia:inventory}{tension} and the electric \omterm{def:g10:inertia:force}{force}: show that $F = mg\tan\theta$ ($\theta$:
angle of thread to vertical) and that here $\tan\theta \approx 0.060$.
Compute $F$, then $q$, then the number of \omterm{def:g11:fundamental-interactions:elementary}{elementary charges} moved.
\end{exercise}
...
distance $d = \qty{3.84e8}{m}$. Compute the Earth--Moon \omterm{def:g10:universal-gravitation:force}{gravitational
...
Compute the \omterm{def:g10:inertia:force}{force} between neighbouring ions and the \omterm{def:g10:universal-gravitation:weight}{weight} of a
...
\omterm{def:g11:fundamental-interactions:ladder}{Atoms} do not implode, nuclei mostly hold, the Moon neither crashes nor
...
\begin{enumerate}
  \item List the floors of the ladder from \omterm{def:g11:fundamental-interactions:ladder}{quark} to galaxy, one \omterm{def:g10:orders-of-magnitude:oom}{order
        of magnitude} of size each.
  \item Scale model: the \omterm{def:g11:fundamental-interactions:ladder}{nucleus} becomes a \qty{1}{cm} marble; how wide
        is the \omterm{def:g11:fundamental-interactions:ladder}{atom}?
  \item What fraction of an \omterm{def:g11:fundamental-interactions:ladder}{atom}'s volume does its \omterm{def:g11:fundamental-interactions:ladder}{nucleus} occupy?
  \item A hair is \qty{70}{\micro m} thick. How many \omterm{def:g11:fundamental-interactions:ladder}{atoms} span it?
  \item How many \omterm{def:g10:energy-conservation:power}{powers} of ten from the \omterm{def:g11:fundamental-interactions:ladder}{quark} ceiling (\qty{e-18}{m})
...
\begin{enumerate}[resume]
  \item In a hydrogen \omterm{def:g11:fundamental-interactions:ladder}{atom} the electron sits $d = \qty{5.3e-11}{m}$
        from the proton: compute the electric \omterm{def:g10:inertia:force}{force} between them.
  \item Compute the \omterm{def:g10:universal-gravitation:force}{gravitational force} between them, and the ratio of
        the two. Which one holds the \omterm{def:g11:fundamental-interactions:ladder}{atom} together?
  \item What changes if gravity is switched off inside \omterm{def:g11:fundamental-interactions:ladder}{atoms}? And if
        electricity is?
  \item Why are the ``contact'' \omterm{def:g10:inertia:force}{forces} of everyday life --- the floor
        pushing on your feet, \omterm{def:g10:inertia:inventory}{friction} --- electromagnetic in disguise?
  \item Each of two coins holds about $\num{e23}$ electrons. Transfer
        one electron in a \emph{billion} between them, set them
        \qty{1.0}{m} apart: compute the charges and the \omterm{def:g10:inertia:force}{force}. Conclusion?
  \item Which interaction rules the floors from \qty{e-10}{m} to
        \qty{e4}{m}, and why does the \omterm{def:g11:fundamental-interactions:strong}{strong interaction} not compete?
\end{enumerate}

\medskip
\noindent\textbf{Part III --- The nuclear floor.}
\begin{enumerate}[resume]
  \item Two protons sit \qty{1.0e-15}{m} apart in a \omterm{def:g11:fundamental-interactions:ladder}{nucleus}: compute
        their electric repulsion.
  \item Unrestrained, what acceleration would this \omterm{def:g10:inertia:force}{force} give a proton?
        Compare with $g$.
  \item List the three properties the \omterm{def:g11:fundamental-interactions:strong}{strong interaction} needs to
        explain why nuclei exist, why neutrons are gripped too, and why
        nuclei are tiny.
  \item In a uranium \omterm{def:g11:fundamental-interactions:ladder}{nucleus} (diameter \qty{1.4e-14}{m}, $92$ protons),
        compute the repulsion between two protons at opposite ends. Can
        the \omterm{def:g11:fundamental-interactions:strong}{strong interaction} bind that pair directly? Explain why
        repulsion wins as nuclei grow, and what the neutrons are for.
  \item In one sentence, as promised: what does the \omterm{def:g11:fundamental-interactions:weak}{weak interaction} do?
\end{enumerate}

\medskip
\noindent\textbf{Part IV --- The astronomical floor, and the verdict.}
\begin{enumerate}[resume]
  \item Compute the \omterm{def:g10:universal-gravitation:force}{gravitational force} between the Earth and the Moon.
  \item The Earth contains about $\num{1.8e51}$ protons (and as many
        ...
        electric \omterm{def:g10:inertia:force}{force} match the gravitational one?
  \item Why does \omterm{def:g11:fundamental-interactions:four}{gravitation}, the weakling of question 7, rule
        astronomy? Two reasons.
  \item Verdict --- one sentence per floor (\omterm{def:g11:fundamental-interactions:ladder}{nucleus}, \omterm{def:g11:fundamental-interactions:ladder}{atom} to mountain,
