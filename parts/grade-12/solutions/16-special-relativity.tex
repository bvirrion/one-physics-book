...
\qty{12.5}{s}$. The ship's \qty{10.0}{s} is the \omterm{def:g12:special-relativity:proper-time}{proper time}: the
...
$7.09 \times \num{2.6e-8} = \qty{1.8e-7}{s}$. Classical \omterm{def:g12:projectile-motion:range}{range}
...
\omterm{def:g10:energy-conservation:energy}{energy} cost of further speed) diverges as $v \to c$ --- no finite
...
\omterm{def:g12:special-relativity:proper-time}{Proper time} belongs to the clock present at both \omterm{def:g12:special-relativity:proper-time}{events}: (a) the
...
\qty{66}{\micro s}$; \omterm{def:g12:projectile-motion:range}{range} $\approx \num{3.00e8} \times \num{6.6e-5}
...
the \omterm{def:g12:quantum-world:photon}{photon}'s speed at $c$ in the \omterm{def:g10:relative-motion:frames}{ground frame} too.
...
reads the \omterm{def:g12:special-relativity:proper-time}{proper time}; the ground needs two synchronized clocks.

\textbf{11.} $\gamma = 1/\sqrt{1 - 0.64} = 1/0.6 = 5/3 \approx 1.67$.

\textbf{12.} $10.0/(5/3) = \qty{6.0}{years}$.

\textbf{13.} Outbound $\qty{5.0}{years}$ at $0.8c$: $4.0$ \omterm{def:g10:orders-of-magnitude:lightyear}{light-years}.
...
around --- she accelerates and changes \omterm{def:g12:special-relativity:inertial}{inertial frame}, while the Earth
...
the ground so it ticks true in \omterm{def:g10:universal-gravitation:satellite}{orbit}.
\end{solution}
