...
\qty{5.0}{m/s}$. \omterm{def:g10:relative-motion:trajectory}{Trajectoire}~: la droite $y = \tfrac43 x$. \omterm{def:g12:kinematics-2d:velocity}{Vecteur
vitesse} constant~: \omterm{def:g12:kinematics-2d:uniform}{mouvement rectiligne uniforme}.
\end{solution}
...
$v_3 = (0.88 - 0.28)/0.40 = \qty{1.50}{m/s}$. La \omterm{def:g12:kinematics-2d:velocity}{vitesse} gagne
...
chaque position et \omterm{def:g12:kinematics-2d:velocity}{vitesse} doit nommer son \omterm{def:g10:relative-motion:frame}{référentiel}. Ici~: le
\omterm{def:g10:relative-motion:frames}{référentiel du sol} (route), $x$ le long de la route depuis la position
...
\omterm{def:g12:kinematics-2d:velocity}{vitesse} tourne~: $\vect v$ n'est pas constant, donc la voiture
accélère.
