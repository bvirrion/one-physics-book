...
\omterm{def:g10:relative-motion:frame}{référentiel}}, donc une arrivée plus tôt signifie une frappe plus
tôt. La simultanéité dépend du \omterm{def:g10:relative-motion:frame}{référentiel}~: chaque verdict est
...
\qty{2.2}{\micro s}$. Les deux \omterm{def:g10:relative-motion:frame}{référentiels} s'accordent sur le fait
...
$\approx c$). \omterm{def:g10:relative-motion:frame}{Référentiel} de l'électron~: tube contracté à
...
\omterm{def:g10:relative-motion:frame}{référentiel} sol.
...
= \qty{7.2}{\micro s}$ par jour de \omterm{def:g12:mechanical-waves:delay}{retard}.
