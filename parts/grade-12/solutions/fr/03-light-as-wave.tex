...
plus élevé (\omterm{def:g12:mechanical-waves:wavelength}{longueur d'onde} plus courte, même \omterm{def:g12:mechanical-waves:speed}{célérité} $c$).
\end{solution}
...
Les lampes ont (largement) des \omterm{def:g10:signals-and-waves:frequency}{fréquences} assorties mais ne sont
\emph{pas \omterm{def:g12:mechanical-waves:phase}{en phase}}~: chacune émet de courts trains d'\omterm{def:g10:signals-and-waves:wave}{ondes} à phase
...
phase ensemble et restent \omterm{def:g12:mechanical-waves:phase}{en phase}.
\end{solution}
...
amincit le film, si bien que l'épaisseur qui peignait une
...
La \omterm{def:g10:signals-and-waves:frequency}{fréquence} est fixée par la source~: inchangée. La \omterm{def:g12:mechanical-waves:speed}{célérité}
