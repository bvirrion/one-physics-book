...
plaques et \omterm{def:g12:rc-rl-circuits:inductor}{bobine}, total constant.
\end{solution}
...
Tout dans la \omterm{def:g12:rc-rl-circuits:inductor}{bobine} lorsque $q = 0$, $i = \pm I_0$
...
une pile bouton. \omterm{def:g12:mechanical-waves:phase}{En phase}, parce que seule une \omterm{def:g10:inertia:inventory}{poussée} à la bonne
\omterm{def:g12:oscillators-and-time:phase}{phase} \emph{ajoute} de
l'\omterm{def:g10:energy-conservation:energy}{énergie}
(\omterm{def:g12:oscillators-and-time:resonance}{résonance})~; hors \omterm{def:g12:oscillators-and-time:phase}{phase} elle freinerait le
balancement.
\end{solution}
...
hautes \omterm{def:g12:oscillators-and-time:oscillator}{fréquences} (faible $C$).
...
épouse $f_0$ les \omterm{def:g10:inertia:inventory}{poussées} arrivent \omterm{def:g12:mechanical-waves:phase}{en phase} et construisent le
...
\omterm{def:g11:mechanical-energy:dissipation}{dissipée} chaque cycle~: un \omterm{def:g12:oscillators-and-time:oscillator}{oscillateur}
entretenu.
...
\omterm{def:g12:oscillators-and-time:spring}{raideurs} et masses du quotidien sont désespérément lentes.
...
l'\omterm{def:g10:signals-and-waves:wave}{onde} de la station, résonnant \omterm{def:g12:mechanical-waves:phase}{en phase}, réalimente
