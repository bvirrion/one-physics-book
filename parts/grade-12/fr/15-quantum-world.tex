...
fin laissent une brûlure. La lampe livre bien plus
...
\omterm{def:g10:light-spectra:emission}{raies spectrales}, des électrons qui \omterm{prop:g12:light-as-wave:conditions}{interfèrent} comme
...
\begin{proof}
\omterm{thm:g10:energy-conservation:conservation}{Conservation de l'énergie}, un grain à la fois~: le
...
chaud n'émet que les \omterm{def:g12:oscillators-and-time:oscillator}{fréquences} $(E_p - E_n)/h$ de sa propre échelle
--- un code-barres de raies brillantes --- et un gaz froid vole
exactement ces \omterm{def:g12:oscillators-and-time:oscillator}{fréquences} à la \omterm{def:g10:light-spectra:white}{lumière blanche},
...
\omterm{def:g10:energy-conservation:energy}{énergie}, même direction, \omterm{def:g12:mechanical-waves:phase}{en phase}. Gardez plus
...
\omterm{def:g12:nuclear-energy:units}{électronvolts}, puis les \omterm{def:g12:quantum-world:photon}{photons} par seconde.
\end{exercise}
...
De la \omterm{def:g10:light-spectra:white}{lumière blanche} traverse un bocal d'hydrogène
...
apparaissent dans les \omterm{def:g12:sound-acoustics:timbre}{spectres} d'étoiles chaudes.
\end{exercise}
...
\begin{enumerate}
  \item Calculer l'\omterm{def:g10:energy-conservation:energy}{énergie} d'un
        ...
        \omterm{def:g11:work-of-force:work}{joules} et \omterm{def:g12:nuclear-energy:units}{électronvolts}.
...
\begin{enumerate}[resume]
  ...
  \item Convertir les quatre
        \omterm{def:g12:mechanical-waves:wavelength}{longueurs d'onde} en \omterm{def:g12:oscillators-and-time:oscillator}{fréquences} (en
        $10^{14}\,\unit{Hz}$).
...
\begin{enumerate}[resume]
  ...
  \item Calculer les \omterm{def:g10:energy-conservation:energy}{énergies} des \omterm{def:g12:quantum-world:photon}{photons} des transitions
        $3 \to 2$, $4 \to 2$, $5 \to 2$.
...
Des microfissures dans une cellule se placent bien sous la \omterm{def:g12:projectile-motion:range}{portée} de
