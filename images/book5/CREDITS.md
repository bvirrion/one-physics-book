# Image credits — Book 5 photographs

Files downloaded from Wikimedia Commons on 2026-08-27 at 1600px width.
Licenses verified via the Commons API (`extmetadata`) at download time.

| file | source (Commons) | author | license |
|---|---|---|---|
| `photo-foucault-pantheon.jpg` | [File:Foucault pendulum at Panthéon de Paris (5829606020).jpg](https://commons.wikimedia.org/wiki/File:Foucault_pendulum_at_Panth%C3%A9on_de_Paris_(5829606020).jpg) | Olga Khomitsevich | [CC BY 2.0](https://creativecommons.org/licenses/by/2.0) |
| `photo-einstein-1947.jpg` | [File:Albert Einstein Head.jpg](https://commons.wikimedia.org/wiki/File:Albert_Einstein_Head.jpg) | Orren Jack Turner, Princeton, N.J. | Public domain |
...
| `photo-crab-nebula.jpg` | [File:Crab Nebula.jpg](https://commons.wikimedia.org/wiki/File:Crab_Nebula.jpg) | NASA, ESA, J. Hester and A. Loll (Arizona State University) | Public domain |

## AI-generated illustrations (`ai/`)

Twenty-six illustrations generated with OpenAI image generation
(via Codex CLI) from prompts written by the book's editors; every
prompt is recorded in `ai/PROMPTS.md`. Each image was reviewed for
physical accuracy before inclusion.
